...
CREATE TABLE IF NOT EXISTS `Baby` (
    ...
    `baby_photo_id` INT NULL,
    FOREIGN KEY (`user_id`) REFERENCES `User`(`user_id`),
    FOREIGN KEY (`baby_photo_id`) REFERENCES `Baby_Photo`(`baby_photo_id`)
    );
...
INSERT INTO `Baby_Photo` (`baby_id`, `user_id`, `file_path`, `upload_date`)
VALUES
    (1, 1, '/photos/baby1_photo1.jpg', '2024-09-01 10:00:00'),
    (2, 2, '/photos/baby2_photo1.jpg', '2024-09-05 12:30:00'),
    (3, 3, '/photos/baby3_photo1.jpg', '2024-09-10 15:45:00');
